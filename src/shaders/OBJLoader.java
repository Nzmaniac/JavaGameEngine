...
public class OBJLoader {
    ...
    private static void processVertex(String[] vertexData, List<Integer> indices,
        ...
        Vector3f currntNorm = normals.get(Integer.parseInt(vertexData[2])-1);
        normalsArray[currentVertexPointer*3] = currntNorm.x;
        normalsArray[currentVertexPointer*3+1] = currntNorm.y;
        normalsArray[currentVertexPointer*3+2] = currntNorm.z;
